...
/// Represents a password input field [`<input type="password">`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/password).
#[derive(Debug)]
...
impl Descriptor for PasswordField {
    type Value = String;
